...
class AutoCalibrator:
    ...
    def __init__(self, 
                 ...
                 # Mengfei Mu 20180511
                 # refer to HSPF.chm
                 parameter_ranges = {'IRC':    (1e-10,0.999),
                                     'LZETP':  (0.0,  2.0),
                                     'DEEPFR': (0,      1),
                                     'LZSN':   (0.25,2500),
                                     'UZSN':   (0.25,250), 
    ...
    def run(self, 
        ...
        # Mengfei Mu 20180529
            ...
            dLogNS = (1 - sum((np.array(log_sflows) - np.array(log_oflows))**2) /
                     sum((np.array(log_oflows) - np.mean(log_oflows))**2))
            return dLogNS        
        #
        else:
    ...
    def perturb(self, 
                parallel,
                nprocessors,
                timeout = 300, # Mengfei 20180503, 300
                verbose = True,
                ):
        """
        ...
        # for sim in simulations:
            # print(sim)
        # print('self.perturbations:', self.perturbations)
        #
    ...
    def get_default(self, variable):
        ...
        elif variable == 'CCFACT': return 1.0
        elif variable == 'MGMELT': return 0.25
        # if   variable == 'LZSN':   return 0.05
        # elif variable == 'UZSN':   return 0.10
        # elif variable == 'LZETP':  return 0.02
        # elif variable == 'INFILT': return 0.02

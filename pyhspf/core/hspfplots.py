...
def plot_hydrograph(HUC8, precipitation, simulated_flow, simulated_evap,
    ...
    if tstep == 'daily':
        ...
        evap_lw = 0.6
        flow_marker = 8
        flow_marker_lw = 0.3 # Mengfei Mu 20180524, default=0.6
    else:
    ...
    if observed_flow is not None:
        # Mengfei Mu 20180524
        ax1.plot_date(x = observed_flow[0], y = observed_flow[1], lw = flow_lw,
                  label = 'observed flow', fmt = '-', color = 'k')
        #
...
def plot_dayofyear(HUC8, precipitation, potentialET, simulated_flow, 
    ...
    if observed_flow is not None:
        ...
        # Mengfei Mu 20180524
        subs[1].plot_date(times, observed_flow, label = 'observed flow', 
                        lw = lw, fmt = '-', color = 'k')
        #
    # add an error band

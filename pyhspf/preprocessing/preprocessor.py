...
class Preprocessor:
    ...
    def build_hspfmodel(self, 
        ...
        # Mengfei Mu 20180611
        # add cloud timeseries to hspfmodel
        # use wind data now, need to change later
        with open(self.hwind, 'rb') as f: s, t, data = pickle.load(f)
        factor = 60 * t / 1000 / 24
        wind = [w * factor for w in data]
        hspfmodel.add_timeseries('cloud', self.HUC8, s, wind)
        hspfmodel.assign_watershed_timeseries('cloud', self.HUC8)
        #
